...
ALLOWED_HOSTS = ['backendappinventarios-production.up.railway.app','127.0.0.1','localhost']
LOGIN_URL = '/login/'
...
CSRF_TRUSTED_ORIGINS = ['https://backendappinventarios-production.up.railway.app','https://*.127.0.0.1']
